...
| Mobile Plan Predictor Model | [car_price_factors.ipynb](car_price_factors.ipynb) | Develop model to predict mobile plan user should switch to based on user behavior. | data preprocessing, pandas, sklearn, machine learning classification |

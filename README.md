...
| Mobile Plan Predictor Model | [car_price_factors.ipynb](car_price_factors.ipynb) | Develop model to predict mobile plan user will switch to based on user behavior. | pandas, sklearn, machine learning classification |
